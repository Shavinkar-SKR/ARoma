...
var addToCart = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var db, cartsCollection, _a, menuId, name_1, price, quantity, image, userId, cartItem, result, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                _a = req.body, menuId = _a.menuId, name_1 = _a.name, price = _a.price, quantity = _a.quantity, image = _a.image, userId = _a.userId;
                cartItem = {
                    menuId: menuId,
                    name: name_1,
                    price: price,
