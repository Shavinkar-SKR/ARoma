...
const restaurantRoutes_1 = __importDefault(
  require("./routes/restaurantRoutes")
);
const menuRoutes_1 = __importDefault(require("./routes/menuRoutes"));
const dotenv = __importStar(require("dotenv"));
const restaurantMenuRoutes_1 = __importDefault(
  require("./routes/restaurantMenuRoutes")
);
const feedbackRoutes_1 = __importDefault(require("./routes/feedbackRoutes"));
const serviceRequestRoutes_1 = __importDefault(
...
const resetPasswordRoutes_1 = __importDefault(
  require("./routes/resetPasswordRoutes")
);
//import payment from './routes/paymentRoutes'
dotenv.config();
const MONGODB_URI =
  "mongodb+srv://root:root@aroma.ae0sb.mongodb.net/ARoma?retryWrites=true&w=majority&appName=ARoma&replicaSet=atlas-4uxo98-shard-0&tls=true";
...
const connectWithRetry = (...args_1) =>
  __awaiter(void 0, [...args_1], void 0, function* (attempt = 1) {
    try {
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      httpServer.listen(PORT, () => {
        ...
        console.log(
          `SSE endpoint: http://localhost:${PORT}/order-events/:orderId`
        );
      });
      process.on("SIGINT", () =>
        __awaiter(void 0, void 0, void 0, function* () {
