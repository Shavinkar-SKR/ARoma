        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    res.write("event: initial\ndata: ".concat(JSON.stringify(order), "\n\n"));
                    ...
                    onChange_1 = function (change) {
                        if (change.operationType === "update" && change.fullDocument) {
                            res.write("event: update\ndata: ".concat(JSON.stringify(change.fullDocument), "\n\n"));
                        }
                    };
    ...
    return __awaiter(void 0, __spreadArray([], args_1, true), void 0, function (attempt) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    error_2 = _a.sent();
                    console.error("Connection attempt ".concat(attempt, " failed:"), error_2);
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                httpServer.listen(PORT, function () {
                    ...
                    console.log("SSE endpoint: http://localhost:".concat(PORT, "/order-events/:orderId"));
                });
